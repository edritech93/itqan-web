 ...
 *  AUTH_LOGIN SAGAS
 */
export const getLoginRequest = (args) => {
    return API
        .getLogin(args)
        .then(json => {
 ...
 *  AUTH_RESET SAGAS
 */
export const getResetRequest = (args) => {
    return API
        .getReset(args)
        .then(json => {
            return json;
 ...
 *  AUTH_REGISTER SAGAS
 */
export const getRegisterRequest = (args) => {
    return API
        .getRegister(args)
        .then(json => {
            return json;
...
export const getLogoutRequest = async (args) => {
    let keys = [STORAGE.USER, STORAGE.TOKEN, STORAGE.CONFIGURATION];
    let res = UserDefaults.multiRemove(keys);
